	...
	G.playerManager.abilities[4] = [
		// 	First Ability: Boiling Point
		{
			...
			activate: function () {
				...
				// SFX
				G.createSound('MagmaSpawn0').play();
			},
					...
					[
						new Effect(
							...
							'onStepIn',
							{
								...
								},								effectFn: function (effect, targetArg) {
									if (targetArg instanceof Creature) {
		...
		// 	Fourth Ability: Molten Hurl
		{
			...
			activate: function (path, args) {
				...
				G.cameraShake(0.01, 300, true, 'BOTH', true);
				hurl(path);
			},
		},
	];
